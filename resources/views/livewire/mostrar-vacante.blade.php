<div class="p-10">
    ...
    <div class="md:grid md:grid-cols-6">
        <div class="md:col-span-3">
            <img src="storage/vacantes/{{ $vacante->imagen }}" alt="{{ 'Imagen Vacante' . $vacante->titulo }}">
        </div>
    </div>
    ...
    @guest
        <div class="mt-5 bg-gray-50 border-dashed p-5 text-center">
            <p>
                ¿Deseas aplicar a esta vacante? <a class="font-bold text-rose-800" href="{{ route('register') }}">Obten una
                    cuenta y aplica a estas y otras vacantes</a>
            </p>
        </div>
    @endguest
