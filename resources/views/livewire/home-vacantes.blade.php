                ...
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="text-base text-gray-600 mb-1">{{ $vacante->puesto }}</p>
                        ...
                        <div class="mt-5 md:mt-0">
                            <a class="bg-rose-800 p-3 text-sm uppercase font-bold text-white rounded-lg block text-center" href="{{ route('vacantes.show', $vacante->id) }}">Ver Vacante</a>
                        </div>
                    </div>
                @empty
